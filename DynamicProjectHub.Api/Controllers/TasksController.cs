...
using ModelsTask = DynamicProjectHub.Api.Models.Task; // Use the alias to avoid ambiguity
...
namespace DynamicProjectHub.Api.Controllers
{
    ...
    public class TasksController : ControllerBase
    {
        ...
        // PUT: api/Tasks/5
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTask(int id, ModelsTask task)
        {
            if (id != task.Id)
            {
                return BadRequest();
        ...
        // POST: api/Tasks
        [HttpPost]
        public async Task<ActionResult<ModelsTask>> PostTask(ModelsTask task)
        {
